...
(function ($) {
    ...
    $(document).ready(function () {   
		...
		function resizeToCover(id, vid_w_orig, vid_h_orig, min_w) {
			...
			$('.cover-' + id + ' .cover-video').width($(window).width());
			$('.cover-' + id + ' .cover-video').height($(window).height());
		...
		if(!no_transitions) {
			$('.logo a, .title h1 a, .title a, .thumb a, li.menu-item a, h2 a, a.more-link, .meta a, .project-panel-link, .fullscreen-cover a, .fwt-link, .secondary a, .featured a, #fullscreen-menu a, a.ce-image-link, a.cover-slider-link, a.cover-link').click(function (a) {
